  ...
  const config = {
    ...
    statistic: {
      ...
      content: {
        ...
        formatter: () => ('Sửa nhiệt độ ở đây tí vào vào frontend/src/components/GaugeCard.jsx dòng 289 sử ok chưa')
      }
    },
    gaugeStyle: {
      lineCap: 'round',
...
export { GaugeCard, GaugeCard0, GaugeCard1 };